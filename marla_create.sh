...
echo '   "Runtime": "python3.9",' >> $HOME/.marla/$CLUSTERNAME/coordinator.json
...
echo 'create lambda coordinator function'
...
echo '   "Runtime": "python3.9",' >> $HOME/.marla/$CLUSTERNAME/mapper.json
...
echo '   "Runtime": "python3.9",' >> $HOME/.marla/$CLUSTERNAME/reducer.json
